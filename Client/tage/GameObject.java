...
public class GameObject
{
	...
	*/
	...
	// -------- custom yaw, pitch, and roll methods --------

	public Matrix4f rollObject(float amount, Matrix4f rotation) {
		rotation = new Matrix4f(this.getLocalRotation());
		rotation.rotate(amount, 0, 0, 1);
		return rotation;
	}
	public Matrix4f yawObject(float amount, Matrix4f rotation) {
		rotation = new Matrix4f(this.getLocalRotation());
		rotation.rotate(amount, 0, 1, 0);
		return rotation;
	}
	public Matrix4f pitchObject(float amount, Matrix4f rotation) {
		rotation = new Matrix4f(this.getLocalRotation());
		rotation.rotate(amount, 1, 0, 0);
		return rotation;
	}
